                ...
                <div class="">
                    ...
                    <div class="">
                        <label class="d-flex">
                            ...
                            <span class="agree">I have read and agree to <a class="underline" target="_blank" href="{{config('blog.menu.privacy_policy')}}">Privacy Policy</a> .</span>
                        </label>
                    </div>
        ...
        <form class="account_form form_request" id="register" data-fn="register_res" method="post" action="/account/register?redirect={{urlencode(request()->query('redirect',''))}}">
            ...
            <div class="accountContent">
                ...
                <div class="">
                    <div class="form-group">
                        <label>Mobile</label>
                        <input type="text" name="id" class="form-control" required autocomplete="off" placeholder="Phone">
                        <div class="invalid-feedback"></div>
                    </div>
                    <div class="form-group">
                        <label>Password</label>
