...
<div class="imain">
    <div class="itop ">
        <form method="get" action="/blog_admin/subscribe/index" class="select_form">
    ...
    <form method="post"  @if($res['search']['string']) action="/blog_admin/subscribe/del?{{$res['search']['string']}}" @else action="/blog_admin/subscribe/del" @endif  class="del_form">
    @csrf
            ...
            <div class="table">
                ...
                @if($res['list']->total())
                    ...
                    <ul class="table_tbody">
                        ...
                        <li>{{ $v->created_at }}</li>
                        <li>
                            <a class="badge badge-info ajax_html" data-href="/blog_admin/subscribe/form?id={{$v['id']}}">编辑</a>
                        </li>
                    </ul>
                    @endforeach
